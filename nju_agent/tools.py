...
class LocalTools:
    ...
    def definitions(self) -> list[dict[str, Any]]:
        return [
            ...
            self._definition("write_file", "Create a new UTF-8 text file, or fully overwrite the explicitly requested path. For modifying an existing file, prefer edit_file so the source file is changed in place.", {"path": {"type": "string", "description": "Relative file path."}, "content": {"type": "string", "description": "Complete file content."}}, required=["path", "content"]),
            self._definition("edit_file", "Modify an existing UTF-8 source file in place by replacing one exact text snippet. The old text must occur exactly once; do not create a copy of the file.", {"path": {"type": "string", "description": "Relative file path."}, "old_text": {"type": "string", "description": "Exact text to replace."}, "new_text": {"type": "string", "description": "Replacement text."}}, required=["path", "old_text", "new_text"]),
